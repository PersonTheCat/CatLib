...
public class DynamicCategoryBuilder {
    ...
    public static class ToggleBuilder {
        ...
        public DynamicCategory<Boolean> build(final ModConfigSpec.Builder builder, final Config cfg) {
    ...
    public static class ListBuilder<T> {
        ...
        public DynamicCategory<List<T>> build(final ModConfigSpec.Builder builder, final Config cfg) {
