...
public class CommonRegistries {
    ...
    public static final RegistryHandle<MapCodec<? extends ConditionSource>> MATERIAL_CONDITION = RegistryUtils.getHandle(Registries.MATERIAL_CONDITION);
    public static final RegistryHandle<MapCodec<? extends RuleSource>> MATERIAL_RULE = RegistryUtils.getHandle(Registries.MATERIAL_RULE);
